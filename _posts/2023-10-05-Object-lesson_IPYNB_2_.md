...
public class Strings_demo {
    public static void main(String[] args) { //main code
        String s1 = "hello"; // The way you are probably used to for string objects - called autoboxing
...
```
    ...
    In order to type out a \\ string in Java String, you need 4 \'s 
     You need 3 \'s and 1 " to type out a \"
...
public class Strings_demo_2 {
    public static void main(String[] args) { //main code
        String s1 = "hello"; // Strings for demonstration - autoboxing
...
public class PopcornHack {
    public static void main(String[] args) {
        String str1 = "APCSA";
        String str2 = new String("woihAPCSAweogih");
...
public class GuessingGame {
    public static void main(String[] args) {
        ...
        while(true) {
            ...
            if(intInput == random) {
                System.out.println("Congratulations! You have guessed the number " + random);
                break;
            }
...
```
    ...
    Too High
    Too High
    Congratulations! You have guess the number 21
