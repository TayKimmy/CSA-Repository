...
```
    ...
    Enter a double, 0 to exit: 19.23
    Enter a double, 0 to exit: 45.36
    Enter a double, 0 to exit: 99.99
...
public class JavaPrimitives {
    public static void main(String[] args) {
        ...
        try {
            ...
            inputInt += 2;
            System.out.println("Compound Assignment Result: " + inputInt);
        } catch (Exception e) {
        ...
        try {
            ...
            System.out.println("Double + Integer: " + inputInt + " + " + inputDouble + " = " + (inputInt + inputDouble));
        } catch (Exception e) {
            System.out.println("Not a double:" + e);
        }
        System.out.println("True or False: The Sun is hot ");
        try {
            ...
            System.out.println("Not a boolean:" + e);
        }
        System.out.println("Enter your name: ");
        try {
            String inputString = input.nextLine();
            System.out.println("Your name is " + inputString + " and it is " + inputString.length() + " letters.");
        } catch (Exception e) {
            System.out.println("Not a string:" + e);
        }
    }
}
JavaPrimitives.main(null);
```

    Enter an integer: 
    24
    Compound Assignment Result: 26
    Enter a double: 
    293856.23956
    Double + Integer: 26 + 293856.23956 = 293882.23956
    True or False: The Sun is hot 
    true
    Wow, you are correct!
    Enter your name: 
    Your name is Tay and it is 3 letters.
...
public class PPGCalculator {
    public static void main(String[] args) {
        Scanner input = new Scanner(System.in);

        // Input for total points scored (int)
        System.out.print("Enter total points scored: ");
        int totalPoints = input.nextInt();

        // Input for number of games played (int)
        System.out.print("\nEnter number of games played: ");
        int gamesPlayed = input.nextInt();

        // Calculate points per game (PPG) as a double
        double ppg = (double) totalPoints / gamesPlayed;

        // Input for player's name (String)
        ...
        System.out.println("\nPlayer Statistics");
        System.out.println("-----------------");
        System.out.printf("%-20s: %s%n", "Player's Name", playerName);
        System.out.printf("%-20s: %d%n", "Total Points", totalPoints);
        System.out.printf("%-20s: %d%n", "Games Played", gamesPlayed);
        System.out.printf("%-20s: %.2f%n", "Points per Game (PPG)", ppg);
    }
}
PPGCalculator.main(null);
```

    Enter total points scored: 
    Enter number of games played: 
    Enter player's name: 
    Player Statistics
    -----------------
