...
## Hacks
- Add to this Notebook some key elements you idetified in this Pseudo Code about sequence, condition selections, and iteration.
- Login in to College Boards AP Classroom and find a link in about pseudo code. Reference materials you find and document interesting in the reference.